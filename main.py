...
@bot.command()
async def mem1(ctx):
    with open('images/bmeme1.jpg', 'rb') as f:
        # ¡Vamos a almacenar el archivo de la biblioteca Discord convertido en esta variable!
        picture = discord.File(f)
    # A continuación, podemos enviar este archivo como parámetro.
    await ctx.send(file=picture)
...
@bot.command()
async def mem2(ctx):
    with open('images/bmeme2.jpeg', 'rb') as f:
        # ¡Vamos a almacenar el archivo de la biblioteca Discord convertido en esta variable!
        picture = discord.File(f)
    # A continuación, podemos enviar este archivo como parámetro.
    await ctx.send(file=picture)
...
@bot.command()
async def mem3(ctx):
    with open('images/bmeme3.jpeg', 'rb') as f:
        # ¡Vamos a almacenar el archivo de la biblioteca Discord convertido en esta variable!
        picture = discord.File(f)
    # A continuación, podemos enviar este archivo como parámetro.
    await ctx.send(file=picture)
...
@bot.command()
async def mem4(ctx):
    with open('images/bmeme4.jpeg', 'rb') as f:
        # ¡Vamos a almacenar el archivo de la biblioteca Discord convertido en esta variable!
        picture = discord.File(f)
    # A continuación, podemos enviar este archivo como parámetro.
    await ctx.send(file=picture)
...
async def menu(ctx):
    view = MenuView()
    await ctx.send("¿Ya quieres que las nvovedades lleguen?:", view=view)
